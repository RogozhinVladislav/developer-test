<template>
  <div class="random-wrapper">
    <div class="categories-wrapper" v-on-clickaway="onClickAway">
      <div class="select-button" @click="toggleShowCategories">
        <div class="selected-value">{{selectedCategory ? selectedCategory : 'Выбрать категорию'}}</div>
